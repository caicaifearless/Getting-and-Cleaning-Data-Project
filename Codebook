...
1. Added a new feature ***activitylabel*** - factor variable for activities with the following levels: *walk*, *walkup*, *walkdown*, *sit*, *stand*, *lay*. 

2. Tidy dataset was build as a mean values of features grouped by ***activity*** and ***subject*** - for each subject and activity type determined mean values over all activities of that type.  
